...
class _EditNoteScreenState extends State<EditNoteScreen> {
  ...
  void _updateNote() {
    ...
    Provider.of<VisualNotes>(context, listen: false).editNote(
        noteId,
        title,
        _descriptionController.text,
        '$dateDisplayed $timeDisplayed',
        _pickedImage,
        status);
  ...
  Widget build(BuildContext context) {
    ...
    noteId = arguments != null ? arguments['id'] : 'no';
    return Scaffold(
        appBar: AppBar(
        ...
        body: FutureBuilder(
            future:
                Provider.of<VisualNotes>(context, listen: false).fetchNote(noteId),
